...
| **Base** | Fusão de PRD v3.0 (Context-First) + PRD v4.1 (Dual-Path) + PRD Fechamento |
...
| CSOSN | CST Equivalente | Efeito Tributário |
|---|---|---|
| 101 | 00 | Tributada integralmente |
| 102, 103, 300, 400 | 40 | Isenta / Não tributada |
| 201, 202 | 10 ou 70 | Com ST |
...
def build_full_context(file_id: int, mode: str, db: Database) -> ValidationContext:
    ...
    # 6. Carregar emitentes_crt do histórico
...
| `E110_SALDO_INCONSISTENTE` | error | objetivo | E110.VL_SLD_APURADO ≠ débitos - créditos calculados |
...
| IPI | `XML_IPI_*`, `XML_CST_IPI_*` | Decreto 7.212/2010 (RIPI) + Tabela TIPI + IN RFB 1.911/2019 |
...
*SPED EFD Validator v5.0 — PRD de Auditoria Fiscal ICMS/IPI*
...
*Documento mestre — fusão de PRD v3.0 + PRD v4.1 + PRD Fechamento*
