...
_KNOWN_ERROR_TYPES: set[str] = {
    ...
    # apuracao_validator.py (PRD v2 Fase 1)
    "RF001_DEBITOS_DIVERGENTE", "RF002_CREDITOS_DIVERGENTE",
    "RF003_SALDO_INCONSISTENTE", "RF003_RECOLHER_INCONSISTENTE",
    "RF003_CREDOR_INCONSISTENTE",
    "RF004_AJ_DEBITOS_DIVERGENTE", "RF004_AJ_CREDITOS_DIVERGENTE",
    "RF004_AJ_DEDUCAO_DIVERGENTE",
    "RF008_E116_AUSENTE", "RF009_E116_VALOR_DIVERGENTE",
